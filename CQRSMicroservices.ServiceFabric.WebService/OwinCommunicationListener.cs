...
namespace CQRSMicroservices.ServiceFabric.WebService
{
    ...
    public class OwinCommunicationListener : ICommunicationListener
    {
        ...
        public OwinCommunicationListener(ServiceContext serviceInitializationParameters, IOwinAppBuilder startup, string appRoot = null, string endpointName = "ServiceEndpoint")
        {
        ...
        public Task<string> OpenAsync(CancellationToken cancellationToken)
        {
            EndpointResourceDescription serviceEndpoint =
                _serviceInitializationParameters.CodePackageActivationContext.GetEndpoint(_endpointName);
            int port = serviceEndpoint.Port;
            string appRoot = string.IsNullOrWhiteSpace(_appRoot) ? string.Empty : _appRoot.TrimEnd('/') + '/';

            var statefulServiceInitializationParameters =
                _serviceInitializationParameters as StatefulServiceContext;
            ...
            else if (_serviceInitializationParameters is StatelessServiceContext)
            {
